    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          {/* Right Image */}
          <div className="relative h-64 sm:h-80 md:h-96 lg:h-[450px] bg-gradient-to-br from-primary to-primary/70 rounded-2xl sm:rounded-3xl overflow-hidden flex items-center justify-center animate-slide-right animate-shadow-glow">
            ...
            <div className="relative z-10 text-center p-4 sm:p-6 md:p-8">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-3 sm:mb-4 rounded-xl sm:rounded-2xl bg-primary-foreground/10 backdrop-blur-sm flex items-center justify-center animate-bounce-soft">
